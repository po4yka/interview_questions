...
pytest.importorskip("langchain", reason="LangChain must be installed for technical validation")


def test_agent_executor_available_from_langchain_module():
    """Ensure the canonical AgentExecutor symbol remains available."""

    module = importlib.import_module("langchain.agents.agent")
...
def test_technical_validation_imports_canonical_agent_executor():
    ...
    langchain_module = importlib.import_module("langchain.agents.agent")
