...
Время запуска приложения напрямую влияет на пользовательский опыт. Android разделяет запуски приложений на три типа в зависимости от того, что уже находится в памяти и что нужно загрузить.
