...
ART — это управляемая среда выполнения, которая исполняет код Android-приложений. Понимание её внутреннего устройства помогает оптимизировать производительность приложений и устранять проблемы.
