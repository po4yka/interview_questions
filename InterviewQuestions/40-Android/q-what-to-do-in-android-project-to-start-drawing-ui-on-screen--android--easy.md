---
id: android-170
title: What To Do In Android Project To Start Drawing UI On Screen / Что делать в
  Android проекте чтобы начать рисовать UI на экране
aliases:
- What To Do In Android Project To Start Drawing UI On Screen
- Что делать в Android проекте чтобы начать рисовать UI на экране
topic: android
subtopics:
- activity
- ui-compose
...
- slug: android-170-0-en
  language: en
  anki_id: 1768398426958
  synced_at: '2026-01-23T16:45:05.538658'
- slug: android-170-0-ru
  language: ru
  anki_id: 1768398426983
  synced_at: '2026-01-23T16:45:05.540502'
---
# Вопрос (RU)
