...
status: draft
moc: moc-cs
related: [q-clean-code-principles--software-engineering--medium, q-launch-vs-async-error-handling--programming-languages--medium, q-visitor-pattern--design-patterns--hard]
created: 2025-10-15
tags: [adapter, design-patterns, gof-patterns, structural-patterns, wrapper]
date created: Monday, October 6th 2025, 7:19:46 am
