...
related: [q-message-queues-event-driven--system-design--medium, q-horizontal-vertical-scaling--system-design--medium, q-database-sharding-partitioning--system-design--hard]
